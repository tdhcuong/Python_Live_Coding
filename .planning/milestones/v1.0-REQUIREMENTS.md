...
- [x] **TUNA-01**: App can be exposed to the internet using localtunnel (`lt`) — cloudflared recommended as primary
- [x] **TUNA-02**: App can be exposed to the internet using ngrok — cloudflared recommended as primary
- [x] **TUNA-03**: WebSocket connections work correctly through both tunnel providers
...
| TUNA-01 | Phase 5 | Complete (cloudflared recommended) |
| TUNA-02 | Phase 5 | Complete (cloudflared recommended) |
| TUNA-03 | Phase 5 | Complete |
