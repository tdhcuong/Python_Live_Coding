...
echo ""
echo "    cloudflared (recommended):  cloudflared tunnel --url http://localhost:8000"
echo "    ngrok:                      ngrok http 8000"
echo "    localtunnel:                npx localtunnel --port 8000"
echo ""
echo "  Then share the public URL with participants."
echo "  WebSocket connections work through all providers (cloudflared and ngrok are most reliable)."
echo ""
